...
class Home : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        app = application as WitParkingApp
...
//        }
        ...
        val fragment = SubscriptionFragment.newInstance()
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.nav_subscription ->
                navigateTo(SubscriptionFragment.newInstance())
            R.id.nav_report ->
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.action_subscription -> toast("You Selected Parking")
    ...
    override fun onRequestPermissionsResult(
        ...
        Log.v(
            "Parking",
            "Home LAT: ${app.currentLocation.latitude} LNG: ${app.currentLocation.longitude}"
        )
    }
}
